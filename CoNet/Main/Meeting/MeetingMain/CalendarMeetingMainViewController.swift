...
class CalendarMeetingMainViewController: UIViewController {
    // MARK: UIComponents
...
extension CalendarMeetingMainViewController: UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout {
    // 각 셀을 클릭했을 때 이벤트 처리
